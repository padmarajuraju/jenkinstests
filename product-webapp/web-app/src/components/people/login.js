...
function Login() {
    ...
    const onSubmit = user => {
        ...
        fetch('http://52.71.36.236:8080/authentication-service/api/v1/login', requestOptions)
            .then((result) => {
                if (result.status === 200) {
                    ...
                    fetch('http://52.71.36.236:8080/user-service/api/v1/user/alluser/'+user.userEmail, requestOptions1).then((res)=>{
                        if(res.status==200){
