...
function VCLogin() {
    ...
    const onSubmit = user => {
        ...
        fetch('http://52.14.203.230:8081/authentication-service/api/v1/login', requestOptions)
            .then((result) => {
                    if (result.status === 200) {
                        ...
                        fetch('http://52.14.203.230:8081/user-service/api/v1/vaccination-center/specific/'+user.userEmail, requestOptions1).then((res)=>{
                            if(res.status==200){
