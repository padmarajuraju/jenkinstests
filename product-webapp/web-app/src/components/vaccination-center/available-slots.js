...
function AvailableSlots() {
    ...
    const onSubmit = (event) => {
        ...
        // if (slotsDetails?.length == 0) {
            ...
            fetch('http://52.14.203.230:8081/vaccination-center-service/api/v1/slots/create', requestOptions)
                .then((result) => {
        ...
        //             };
        //             fetch('http://localhost:8081/vaccination-center-service/api/v1/slots/add/' + item.id, requestOptions)
        //                 .then((result) => {
        ...
        //                 body: JSON.stringify({ ...createSlots })
        //             };
        //             fetch('http://localhost:8081/vaccination-center-service/api/v1/slots/create', requestOptions)
        //                 .then((result) => {
        //                     if (result.status === 201) {
        //                         setOpen(false);
        //                         getSlotsDetails();
    ...
    const onEditSubmit = (event) => {
        ...
        fetch('http://52.14.203.230:8081/vaccination-center-service/api/v1/slots/update', requestOptions)
            .then((result) => {
                if (result.status === 200) {
                    setEditOpen(false)
                    getSlotsDetails();
    ...
    const onDelete = (event) => {
        ...
        fetch('http://52.14.203.230:8081/vaccination-center-service/api/v1/slots/' + modalSlotData.slotId, requestOptions)
            .then((result) => {
                if (result.status === 200) {
                    setEditOpen(false)
                    getSlotsDetails();
    ...
    const getSlotsDetails = () => {
        return fetch("http://52.14.203.230:8081/vaccination-center-service/api/v1/slots/available/center/" + emailPass, {
            headers: {
